...
public class Vector2D
{
    ...
    // Changes vector's range between 0 and 1
    ...
    public static Vector2D lerp(final Vector2D a, Vector2D b, float t)
    {
        if((double)(t) < 0.0)
        {
            t = 0.0f;
        ...
        return new Vector2D(a.getX() + (b.getX() - a.getX()) * t, a.getY() +
                (b.getY() - a.getY()) * t);
    }
